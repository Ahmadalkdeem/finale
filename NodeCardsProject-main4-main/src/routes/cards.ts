...
router.get("/filtering/shoesproduct", validatefind, skip, Finddate, (req: any, res) => {
...
router.get("/filtering/Shirtsproduct", validatefind, skip, Finddate, (req: any, res) => {
    let numberskip = Number(req.query.skip)
...
router.get("/filtering/pantsproduct", validatefind, skip, Finddate, (req: any, res) => {
    let numberskip = Number(req.query.skip)
...
router.get("/brands/filtering", validatefind, skip, Find2, (req: any, res) => {
    let numberskip = Number(req.query.skip)
